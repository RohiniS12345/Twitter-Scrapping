...
client = pymongo.MongoClient("mongodb+srv://localhost:27017@cluster0.wqerix2.mongodb.net/?retryWrites=true&w=majority")
twtdb = client.localhost
twtdb_main = twtdb.tweets_df
